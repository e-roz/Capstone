...
{
    /// <summary>
    /// The three files collected at the document step, each with what the phone read
    /// from it.
    /// </summary>
    /// <remarks>
    ...
    /// request rather than here. A first submission needs all three; an applicant
    /// answering a reviewer's request for one unreadable receipt sends that receipt
    /// alone, and requiring the other two would be the system asking for

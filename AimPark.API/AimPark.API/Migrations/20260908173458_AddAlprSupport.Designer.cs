...
namespace AimPark.API.Migrations
{
    ...
    [Migration("20260908173458_AddAlprSupport")]
    partial class AddAlprSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AimPark.API.Entities.AlprReading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Gate", "ConsumedAt", "ReadAt");

                    b.ToTable("AlprReadings");
                });
            ...
            modelBuilder.Entity("AimPark.API.Entities.GateAccessAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<double?>("AlprConfidence")
                        .HasColumnType("double precision");

                    b.Property<string>("AlprPlateNumber")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<Guid?>("ResultingLogId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AimPark.API.Entities.AlprReading", b =>
                {
                    b.HasOne("AimPark.API.Entities.GateDevice", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("AimPark.API.Entities.GateAccessAttempt", b =>
                {
                    b.HasOne("AimPark.API.Entities.ParkingLog", "ResultingLog")
                        .WithMany()
                        .HasForeignKey("ResultingLogId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AimPark.API.Entities.User", "ReviewedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AimPark.API.Entities.ParkingLog", b =>
                {
                    b.HasOne("AimPark.API.Entities.AlprReading", "AlprReading")
                        .WithMany()
                        .HasForeignKey("AlprReadingId")
                        .OnDelete(DeleteBehavior.SetNull);
